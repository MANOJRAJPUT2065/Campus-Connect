...
import { FaVideo, FaUsers, FaCalendar, FaClock, FaPlay, FaPlus, FaSignOutAlt, FaEye, FaHistory, FaArrowRight } from 'react-icons/fa';
...
const TeacherDashboard = () => {
    ...
    try {
      ...
      const response = await fetch(buildApiUrl('/api/sessions/create'), {
        ...
        body: JSON.stringify({
          ...
          instructorId: userInfo?.email || userInfo?.userId,
      ...
      if (data.success) {
        ...
        setFormData({ title: '', maxParticipants: 50, allowChat: true, allowScreenShare: true, allowRecording: true });
        // Navigate using the channelName from response
  ...
  const startSession = (channelName) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.button
          ...
          className="mb-8 flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg transition-colors"
        >
          <FaPlus />
          Create New Class
        </motion.button>
